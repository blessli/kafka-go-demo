...
var (
	...
	messageLoad   = kingpin.Flag("message-load", "REQUIRED: The number of messages to produce to -topic.").Default("500000").Int()
	...
	topic      = kingpin.Flag("topic", "REQUIRED: The topic to run the performance test on.").Default("localtest").String()
	partition = flag.Int(
		"partition",
		-1,
